		 ...
		 echo "<script type='text/javascript'>
            setTimeout(function () {  
                swal({
                    ...
                    className: 'red-bg',
                    buttons: false,
                    title: 'Sebelumnya Anda sudah memilih ketos, dilarang memilih ketos kembali!',
...
if (isset($_POST['btnKetos']) === true) {
	...
	$insertData = mysqli_query($link, "INSERT INTO data_total_osis (nis_siswa, nama_siswa, kelas_siswa, nama_osis) VALUES ('$nisSiswa', '$namaSiswa', '$kelasSiswa', '$namaOsis')");
		 ...
		 echo "<script type='text/javascript'>
            setTimeout(function () {  
                swal({
                    ...
                    text:  'Redirecting to page vote ketos...',
                    type: 'error',
                    timer: 2000,
                    showConfirmButton: false
                    });  
...
<body class="bg-dark">
<div class="container">
	<h3 class="text-white text-sm-center m-3">Pemilihan Ketua Osis</h3>
	<div class="row" style="margin-top: 25px;">
		<div class="col-sm-12" style="margin: auto; display: flex; justify-content: space-between; max-width: 1200px;">
			<?php 
				$resultData = mysqli_query($link, "SELECT * FROM data_osis");
			...
			<div class="card-body">
				<div class="mx-auto d-block">
					...
					<h5 class="text-sm-center mt-2 mb-1"><?= $rowData['nama_osis'] ?></h5>
					...
					<div class="card-text text-sm-center">
						<form method="post" action="">
							...
							<!-- Form Data -->
 							<input type="hidden" name="namaOsis" value="<?= $rowData['nama_osis'] ?>">
							...
							<?php $namaOsis = $rowData['nama_osis']; ?>
							<?php if (!isset($_SESSION['vote-ketos'])): ?>
								'<button type="submit" name="btnKetos" class="btn btn-success" onclick="return confirm('Apakah anda yakin ingin memilih <?= $namaOsis ?> sebagai ketua Osis?')"><i class="fas fa-check"></i> Vote</button>
							<?php endif ?>
						 </form>
					</div>
				</div>
